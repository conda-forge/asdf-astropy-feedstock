...
Once the `conda-forge` channel has been enabled, `asdf-astropy` can be installed with:

```
conda install asdf-astropy
```

It is possible to list all of the versions of `asdf-astropy` available on your platform with:
